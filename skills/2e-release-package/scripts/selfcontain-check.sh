...
#
# B1-B5 are the five checks 2d-release-scope defines for a scope index, applied to
...
# row DECLARES the split — the deliberate partial inclusion 2d-release-scope allows.
#
