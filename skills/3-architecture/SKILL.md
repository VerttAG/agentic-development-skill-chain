---
name: 3-architecture
description: "Design PM-friendly technical architecture for one PROJ across all its PRDs: high-level decisions, no code. Use when all PRDs exist and need a unified tech design, before implementation plans."
license: MIT
---
...
Ask about cross-cutting concerns. Use a structured-choice tool if the host has one (Claude Code: `AskUserQuestion`); otherwise ask them as one numbered question block and wait for the answers:
