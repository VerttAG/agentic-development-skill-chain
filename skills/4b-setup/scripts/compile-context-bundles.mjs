...
// (4b-setup: Compile the context bundles, via state.sh).
//
// Usage:
...
function rolesDir() {
  ...
  if (existsSync("templates/roles")) return "templates/roles";           // repo copy (4b-setup installs)
...
function sourceContent(id) {
  switch (id) {
    ...
    case "ground-file":          return { title: `Validated assumptions (${BASE}/ground-file.md)`, text: readOr(join(BASE, "ground-file.md"), "generated in P0 (4b-setup: Generate the ground file)") };
