---
name: sonar-cli
description: "Set up, run, troubleshoot and triage SonarQube Cloud/Server analysis. Use for SonarScanner CLI, sonar-project.properties, SONAR_TOKEN, quality gates, coverage/LCOV import, issue and hotspot queries, or scanner auth failures."
license: MIT
compatibility: Requires sonar-scanner or the sonar CLI, plus a SONAR_TOKEN for the target SonarQube Cloud/Server project.
---
