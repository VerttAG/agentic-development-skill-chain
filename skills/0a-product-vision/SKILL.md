---
name: 0a-product-vision
description: "Once per product: interview the owner into docs/PRODUCT.md (purpose, audience, non-goals, success) and cut the product into a numbered PROJ map. Use for a new product or a direction change. Not for one feature (use 1-brainstorming)."
license: MIT
---
...
| Existing codebase | `0b-intake` | scan → provenance-marked drafts → interview |
...
Source: `docs/PRODUCT.md` · Numbers allocated here · Status updated by `1-brainstorming`
