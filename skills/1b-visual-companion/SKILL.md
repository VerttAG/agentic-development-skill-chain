---
name: 1b-visual-companion
description: "Decide the rough shape of a UI before requirements: sidepanel vs modal vs drawer vs split view vs wizard vs page, navigation model, screen flow. Produces clickable low-fidelity HTML. Not for polished visual design or final mockups."
license: MIT
---
...
> in `1c-frontend-design`, or skip and let `ui-mockup` use greyscale wireframes?"
...
- Decision: build it in `1c-frontend-design` | skip knowingly (<one-line reason>) | already exists
